...
func TestCreateInstanceFromAMI_HappyPathNoUserData(t *testing.T) {
	...
	err := CreateInstanceFromAMI(context.Background(), term, le, map[string]awsclient.EC2API{"us-east-1": ec2Client}, map[string]awsclient.SSMAPI{"us-east-1": ssmClient}, images)
	if err != nil {
