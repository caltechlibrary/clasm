...
- [ ] Configure clasm domain -- a sixth top-level menu for viewing/creating/updating `~/.clasm` (regions, backup directory rules, Origin tag config) from within clasm instead of hand-editing YAML. Designed 2026-07-24, targeted for v0.0.5, not yet implemented -- see DESIGN.md, "Configure clasm Domain", DECISIONS.md, "Configure clasm domain: explicit Save, region changes deferred to next launch", PLAN.md Phase 20.42.
